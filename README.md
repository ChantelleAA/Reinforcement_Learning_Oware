...
The game can be easily modified and extended for different reinforcement learning scenarios, for experimenting with various strategies in the Oware game.
